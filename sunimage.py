...
def diskinf(vis, sizescale=1.0, fdens=None, dsize=None, overwrite=True, xmlfile='SOLDISK.xml'):
    if fdens is None:
...
def pipeline_run(vis, outputvis='final.ms', workdir=None, slfcaltbdir=None, imgoutdir=None, figoutdir=None):
    ...
    figfile, a = plt_eovsa_image(eofiles_new[:-1], figoutdir)  # skip plotting the image of the highest bands

    return ms_slfcaled, diskxmlfile, b, a
